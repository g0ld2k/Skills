...
Pass: The skill identifies the changed tree, discards the stale draft, recollects
staged evidence, and runs the same gate for the new tree and message. Attended
approval is requested again; recorded preauthorization is re-evaluated.
